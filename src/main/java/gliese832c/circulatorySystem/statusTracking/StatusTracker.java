...
public class StatusTracker {
    ...
    public StatusTracker(String key, String chatInfoMessage, boolean dieOn100Percent, @Nullable String customDeathMessage, ResourceLocation resourceLocation, ArrayList<EffectInfo> potionEffectData) {
        this.key = key;
