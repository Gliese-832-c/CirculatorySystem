...
import gliese832c.circulatorySystem.util.InfoHelper;
import gliese832c.circulatorySystem.util.StackHelper;
...
public class ItemMeta<T extends Enum<T> & IStringSerializable & IMetaEnum> extends Item implements IInfoItem {
    ...
    public ItemMeta(Class<T> enumm, TextFormatting infoColor, String[]... tooltips) {
        setHasSubtypes(true);
        this.enumm = enumm;
    ...
    public ItemMeta(Class<T> enumm, String[]... tooltips) {
