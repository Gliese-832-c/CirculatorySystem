package gliese832c.circulatorySystem.util.codeThatIstoleFromNuclearCraft;
...
public class InfoHelper {
    ...
    public static boolean showFixedInfo(String[] fixedLines, String... lines) {
        return !Arrays.equals(fixedLines, EMPTY_ARRAY) && !Arrays.equals(fixedLines, NULL_ARRAY) && (!Keyboard.isKeyDown(Keyboard.KEY_LSHIFT) || Arrays.equals(lines, EMPTY_ARRAY));
    }

    public static boolean showInfo(String[] fixedLines, String... lines) {
        return (Keyboard.isKeyDown(Keyboard.KEY_LSHIFT) || lines.length == 1) && !Arrays.equals(lines, EMPTY_ARRAY) && !Arrays.equals(lines, NULL_ARRAY);
    }
